...
class _ArbMedicalScreenState extends State<ArbMedicalScreen> {
  ...
  Future<void> _openMap() async {
    ...
    if (Platform.isAndroid) {
      if (await canLaunchUrl(Uri.parse(googleMapsUrl))) {
        ...
        Get.snackbar('error'.tr, 'msg_could_not_open_maps'.tr,
  ...
  Future<void> _makeCall(String number) async {
    ...
    if (await canLaunchUrl(url)) {
      ...
      Get.snackbar('error'.tr, 'msg_could_not_make_call'.tr,
          backgroundColor: Colors.red, colorText: Colors.white);
    }
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDoctorTile(
                      index: 0,
                      role: 'arb_doctor1_role'.tr,
                      name: 'Dr. Muhammad Tufail Bawa',
                      days: 'arb_doctor1_days'.tr,
                      time: 'arb_doctor1_time'.tr,
                    ),
                    _buildDoctorTile(
                      index: 1,
                      role: 'arb_doctor2_role'.tr,
                      name: 'Dr. Sana Fateh',
                      days: 'arb_doctor2_days'.tr,
                      time: 'arb_doctor2_time'.tr,
                    ),
                    _buildDoctorTile(
                      index: 2,
                      role: 'arb_doctor3_role'.tr,
                      name: 'Faiza Aslam',
                      days: 'arb_doctor3_days'.tr,
                      time: 'arb_doctor3_time'.tr,
                    ),
                  ],
                ),
              ),
