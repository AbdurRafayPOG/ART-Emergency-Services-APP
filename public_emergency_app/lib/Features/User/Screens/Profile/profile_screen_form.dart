...
class _ProfileFormWidgetState extends State<ProfileFormWidget> {
    ...
    try {
      ...
      try {
        ...
        if (placemarks.isNotEmpty) {
          ...
          setState(() {
            _address = fullAddress.isNotEmpty ? fullAddress : 'Address not available'.tr;
            _isLoadingAddress = false;
            _hasFetchedLocation = true;
          });
      ...
      setState(() {
        _address = 'Unable to fetch address'.tr;
        _isLoadingAddress = false;
        _hasFetchedLocation = true;
      });
    }
  ...
  Widget _buildProfileContent(bool isSmallScreen) {
    ...
    final userName = _userName.isNotEmpty ? _userName : 'Loading...'.tr;
    final userEmail = _userEmail.isNotEmpty ? _userEmail : user?.email ?? 'Loading...'.tr;
    final userPhone = _userPhone.isNotEmpty ? _userPhone : 'Loading...'.tr;
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Text(
                        'profile_personal_information'.tr,
                        style: TextStyle(
  ...
  Future<void> _executePasswordUpdate(String currentPassword, String newPassword) async {
    ...
    if (currentUser == null) {
      Get.snackbar(
        'Error'.tr,
        'You are not logged in. Please log in again.'.tr,
        snackPosition: SnackPosition.TOP,
        backgroundColor: Colors.red,
        colorText: Colors.white,
        duration: const Duration(seconds: 3),
    ...
    try {
      ...
      switch (e.code) {
        ...
        case 'requires-recent-login':
          errorMessage = 'Please log out and log in again, then try updating your password.'.tr;
          break;
        case 'too-many-requests':
          errorMessage = 'Too many attempts. Please wait and try again later.'.tr;
          break;
        case 'weak-password':
          errorMessage = 'New password is too weak. Use at least 6 characters.'.tr;
          break;
        case 'user-not-found':
          errorMessage = 'User not found. Please log in again.'.tr;
          break;
        case 'user-disabled':
          errorMessage = 'User account is disabled. Contact support.'.tr;
          break;
        case 'network-request-failed':
          errorMessage = 'Network error. Please check your internet connection.'.tr;
          break;
        default:
          errorMessage = 'Error: ${e.code}'.tr;
      }
