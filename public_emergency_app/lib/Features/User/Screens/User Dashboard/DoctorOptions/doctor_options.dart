...
import 'onboard_doctor_certificates.dart';
import 'dart:math';
...
class _DoctorOptionsState extends State<DoctorOptions>
  ...
  void _navigateToOnboardDoctorCertificates() {
    Get.to(() => const OnboardDoctorCertificatesPage());
  }
            ...
            Card(
              ...
              child: Container(
                ...
                child: Material(
                  color: Colors.transparent,
                  child: InkWell(
                    onTap: _navigateToOnboardDoctorCertificates,
                    borderRadius: BorderRadius.circular(16),
                    child: Padding(
                      padding: const EdgeInsets.symmetric(
                        horizontal: 20,
