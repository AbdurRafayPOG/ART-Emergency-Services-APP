...
class GridDashboard extends StatelessWidget {
  ...
  // NOTE: `title` stays in English on purpose — it's used for switch-case
  // navigation and color lookup below, so translating it would break both.
  // `titleKey` / `subtitleKey` are the translation keys used ONLY for display.
  final Items item1 = Items(title: "Police", subtitle: "Emergency Police", titleKey: "police", subtitleKey: "emergency_police", event: "", img: "assets/logos/policeman.png");
  final Items item2 = Items(title: "Fire Brigade", subtitle: "Emergency Fire Brigade", titleKey: "fire_brigade", subtitleKey: "emergency_fire_brigade", event: "", img: "assets/logos/fire-truck.png");
  final Items item3 = Items(title: "Pharmacy", subtitle: "Emergency Pharmacy", titleKey: "pharmacy", subtitleKey: "emergency_pharmacy", event: "", img: "assets/logos/pharmacy.png");
  final Items item4 = Items(title: "Hospitals", subtitle: "Emergency Hospitals", titleKey: "hospitals", subtitleKey: "emergency_hospitals", event: "", img: "assets/logos/hospital.png");
  final Items item5 = Items(title: "Blood Bank", subtitle: "Emergency Blood Services", titleKey: "blood_bank", subtitleKey: "emergency_blood_services", event: "", img: "assets/logos/BloodBank.png");
  final Items item6 = Items(title: "Helpline", subtitle: "Emergency Helpline", titleKey: "helpline", subtitleKey: "emergency_helpline", event: "", img: "assets/logos/Helpline.png");
        ...
        return GridView.count(
          ...
          children: myList.map((data) {
            return GestureDetector(
              onTap: () {
                onItemTap?.call();
                // Navigation logic stays keyed on the ENGLISH title — unaffected by language.
                switch (data.title) {
                  ...
                  default: Get.snackbar("error".tr, "service_not_available".tr);
                }
              },
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // =============================================
                    // TITLE - SAME SIZE FOR ALL 6 GRIDS (translated for display)
                    // =============================================
                    Container(
                    ...
                    // =============================================
                    // SUBTITLE - SAME SIZE FOR ALL 6 GRIDS (translated for display)
                    // =============================================
                    Container(
                      padding: EdgeInsets.symmetric(horizontal: 2),
                      child: FittedBox(
...
class Items {
  String title;      // English key used for navigation/color logic — do not translate
  String subtitle;    // kept for backward-compat / any other logic that reads it
  String titleKey;    // translation key used for DISPLAY text
  String subtitleKey; // translation key used for DISPLAY text
  String event;
  String img;
  Items({
    required this.title,
