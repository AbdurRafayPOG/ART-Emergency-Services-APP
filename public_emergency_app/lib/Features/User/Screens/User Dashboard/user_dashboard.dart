  ...
  Future<void> _fetchWeatherForAppBar() async {
    ...
    try {
      ...
      if (permission == LocationPermission.denied) {
        ...
        if (permission == LocationPermission.denied) {
          setState(() {
            _weatherError = 'location_permission_denied'.tr;
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _weatherError = 'failed_to_load_weather'.tr;
          _isWeatherLoading = false;
        });
      }
    } catch (e) {
      setState(() {
        _weatherError = '${'error_fetching_weather'.tr}: $e';
        _isWeatherLoading = false;
      });
    }
  }
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'haseen_habib_foundation_trust'.tr,
                                style: TextStyle(
                                  fontSize: isSmallScreen 
                                      ? screenWidth * 0.025 
                                      : isLargeScreen 
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: screenHeight * 0.002),
                              Text(
                                "connect_with_doctor_instantly".tr,
                                style: TextStyle(
                                  fontSize: isSmallScreen 
                                      ? screenWidth * 0.025 
                                      : isLargeScreen 
