...
import 'Common Widgets/app_translations.dart';
import 'Common Widgets/language_controller.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      locale: const Locale('en', 'US'), // default language on app start
      fallbackLocale: const Locale('en', 'US'),

      // Keep layout LTR always — only the text should change with language,
      // not the position of buttons/icons/rows across the app.
...
class AppBinding extends Bindings {
  ...
  void dependencies() {
    ...
    // Register LanguageController (single shared instance across the app)
